        ...
        <div class="opciones-registro">
            <div class="opciones-registro">
                <div class="opcion-registro">
                    ...
                    <a href="index.php?pagina=login" class="boton-registro">Registrarse como usuario</a>
                </div>
                <div class="opcion-registro">
                    <div class="icono-registro">
                    ...
                    <a href="index.php?pagina=informacion" class="boton-registro">Registrarse como propietario</a>
                </div>
            </div>
        </div>
    </section>
